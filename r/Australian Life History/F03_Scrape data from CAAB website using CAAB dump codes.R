...
# Need to split name into scientfic and authority
clean.info <- info %>%
...
saveRDS(final.synonyms, "data/caab_synonyms.RDS")
saveRDS(final.caab.codes, "data/caab_scraped_codes_common-names.RDS")
